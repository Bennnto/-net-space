// Ben Promkaew Student ID.101582010
...
namespace Assignment3
{
    ...
    internal class Program
    {
        ...
        {
            Console.Clear(); // Clear console before start program to make it clean and easy to read
        ...
        private static void Range()
        {
            ...
            double Highest = double.MinValue; // Initialize to lowest possible value -infinity to compared with all price in lists to substitute with highest possible value in .txt file
            double Lowest = double.MaxValue;  // Initialize to highest possible value + infinity to compared with all price in lists to substitute with lowest possible value in .txt file
            string Highline = "";
            string Lowline = "";
